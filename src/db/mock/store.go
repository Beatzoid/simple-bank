...
// Source: github.com/beatzoid/simple-bank/db/sqlc (interfaces: Store)
//
// Generated by this command:
//
//	mockgen -package mockdb -destination db/mock/store.go github.com/beatzoid/simple-bank/db/sqlc Store
//
