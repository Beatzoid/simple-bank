...
func (server *Server) createTransfer(ctx *gin.Context) {
	...
	fromAccount, validAccount := server.validAccount(ctx, req.FromAccountID, req.Currency)
	...
	_, validAccount = server.validAccount(ctx, req.ToAccountID, req.Currency)
...
// validAccount checks if the given account ID and currency are valid
